...
func (a Auth) InsertModuleAuthentication(u *models.User, module string, data interface{}) error {
	_, err := a.db.NamedExec(`
		INSERT INTO provider_authentication (user_id, module_name, data)
		VALUES (:user, :module, :data)
