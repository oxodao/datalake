...
func (a Auth) UpsertModuleAuthentication(u *models.User, module string, accountId string, data interface{}) error {
	_, err := a.db.NamedExec(`
		INSERT INTO provider_authentication (user_id, module_name, account_username, data)
		VALUES (:user, :module, :account_username, :data)
		ON CONFLICT (user_id, module_name, account_username) DO UPDATE SET data = :data
